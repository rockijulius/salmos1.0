 ...
 */
public class TipoDeUsuarioDao <Entity extends PersistenceEntity> implements ITipoDeUsuarioDao<Entity>{
    
    protected static EntityManager entityManager;
    
    static{
        EntityManagerFactory fac = Persistence.createEntityManagerFactory("salmos");
