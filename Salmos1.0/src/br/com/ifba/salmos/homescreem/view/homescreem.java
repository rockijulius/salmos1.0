 ...
 * @author admin
 */
public class homescreem extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(homescreem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
